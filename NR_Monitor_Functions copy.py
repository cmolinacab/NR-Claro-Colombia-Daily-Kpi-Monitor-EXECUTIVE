...
# Alarmas de Ofensores de Disponibilidad
    ...
    avail_last_hour=data_hist.groupby('Site').head(1)[['Site','NR_5152a']]
    avail_last_hour.columns=['Sitio','NR_5152a']
...
# Alarmas ANCHOR sites de ofensores
    ...
    alarms_final=on_air_5g.merge(alarms_5g_4g.groupby(['NR_5152a','Sitio', 'DN_5G', 'ALARM_TIME', 'CANCEL_TIME', 'ALARM_NUMBER_5G','TEXT_5G', 'SUPPLEMENTARY_INFO_5G'])\
    ...
    alarms_final=alarms_final[alarms_final['NR_5152a']<99]
